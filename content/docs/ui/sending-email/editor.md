...
<table class="table" style="table-layout:fixed">
  ...
  <tr>
    <td>Unsubscribe</td>
    <td>This module is pre-populated with your sender information and hyperlink to the [unsubscribe] tag which are required in order to be compliant with anti-spam laws.</td>
